package com.canghuang.logincenter.aspect;

import com.canghuang.logincenter.utils.IpUtils;
...
public class ControllerLogAspect {
  ...
  @Pointcut("execution(* com.canghuang.logincenter.controller..*.*(..))")
  ...
  public void deBefore(final JoinPoint joinPoint) {
    ...
    if (attributes != null) {
      ...
      log.debug("==> From IP: {}", IpUtils.getIpAddress(request));
    }
    log.debug(
        "==>  Method: {}",
